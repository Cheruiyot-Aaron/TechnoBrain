...
namespace EmployeeHierarchy
{
    ...
    public List<Employee> LstEmployees => _lstEmployees;
        ...
        public EmployeeHierarchy(string[] data)
    {
        ProcessData(data);
        ...
        private void Add(object managerId, object id)
        {
        ...
        foreach (var li in data)
        {
            try
            {
                ...
                else
                {
                    ...
                    var isvalid = Int64.TryParse(parts[2], out long salary);
    ...
    public Employee LookUp(string id)
    {
        ...
        [Serializable]
        private class SalaryInvalid : Exception
        {
